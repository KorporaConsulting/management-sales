<?php 
 ...
 $m .= '</select>';
?>
<div style="width:100%; height:200px; overflow:auto; color:#000000; margin-bottom:20px;" align="center">
 ...
 <div class="spacer"></div>
     <table>
        ...
        <tr><td>Nama Sales <span class="require">*</span></td><td>:</td><td><input type="text" name="nama_sales" id="nama_sales" disabled maxlength="30" size="30" value="<?= $user['name']?>"></input></td></tr>
        <tr><td>Event <span class="require">*</span></td><td>:</td><td><textarea type="text" name="event" id="event" maxlength="100" size="100" style="width: 500px; height:100px;"></textarea></td></tr>
 ...
 $('.save').click(function(){
  if($('#event').val().length > 0){
   $.ajax({
    ...
    data:{<?php echo "year:$year,mon:$mon,day:$day";?>, hour:$('#hour').val(), minute: $('#minute').val(), nama_sales:$('#nama_sales').val(), event:$('#event').val()},
   ...
   $('#nama_sales').attr('class','error_require')
