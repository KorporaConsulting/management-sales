         ...
         <div class="flash-datas" data-flashdata="<?= $this->session->flashdata('flasha');?>"></div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h2 class="m-0 font-weight-bold text-dark"><center>Data Pembayaran Public</center></h2>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php foreach ($publik5 as $b) : ?>
                    <tr>
                      <td><?php echo $b['nama_sales']; ?>
                      <td>Nama Customer : <?php echo $b['nama_cust']; ?> <br>
                        Telpon : <?php echo $b['telpon']; ?> <br>
                        Email : <?php echo $b['email']; ?> <br>
                        Training Yang Diikuti : <?php echo $b['training']; ?> 
                      </td> 
                      <td><?php echo $b['tgl_pembayaran']; ?></td>
                      <td><?php echo $b['status_pembayaran']; ?></td>
                      <td><?php echo $b['keterangan']; ?></td>
                      <td>
                        <center>
                          <a href="<?php echo base_url();?>publik/proposal_pembayaran/<?= $b['id_public']; ?>" class="badge badge-primary col-12">Proposal</a><br>
